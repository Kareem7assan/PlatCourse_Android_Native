...
object NetWorkModule {
    ...
    fun provideOkHttpClient(loggingInterceptor: HttpLoggingInterceptor,gateway: PreferencesGateway): OkHttpClient {
        ...
        okHttpClient.addNetworkInterceptor { chain ->
            ...
            requestBuilder.addHeader("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoyNiwiZW1haWwiOiJzaGVyaWZlbHRlbHRAeWFob28uY29tIiwiZXhwIjoxNjg0NDQwNTgzLCJpYXQiOjE2NTg1MjA1ODN9.YD3-N5haBNtE8EO4Jao2trNg7R4koCZ6KZps3UgWy-s")
