...
object Deps {
    ...
    object test {
        ...
        const val espresso = "androidx.test.espresso:espresso-core:${Versions.espressoAndroid}"
...
*/
    ...
    object jetpack{
        ...
        const val lifeCycleExtentions = "androidx.lifecycle:lifecycle-extensions:${Versions.lifecycle_version}"
        ...
        const val compilerRoom = "androidx.room:room-compiler:${Versions.room_version}"
        const val testRoom = "androidx.room:room-testing:${Versions.room_version}"
    ...
    object google {
        ...
        const val servicesLocation =  "com.google.android.gms:play-services-location:${Versions.googleServicesLocation}"
