...
object ReplaceCartDialog {

    fun show(restName:String,activity: Activity, func: (() -> Unit)? = null) {
        val dialog = CustomDialogBuilder(activity, R.layout.dialog_replace)
            .cancelable(true)
        ...
        msg?.text=String.format(activity.getString(R.string.replace_with_new_cart),restName)
