...
class IFramePlayerOptions private constructor(private val playerOptions: JSONObject) {
  ...
  companion object {
    val default = Builder().controls(1)
      .fullscreen(1)
      //.enablejsapi()
      .disableKeyBoard()
      .rel(0)
  ...
  class Builder {
    companion object {
      ...
      private const val disable_key_board = "disablekb"
    ...
    fun disableKeyBoard(): Builder {
      addInt("disablekb", 1)
      addInt("showinfo", 0)
      addString("color", "white")
      addInt(REL, 0)
      return this
    }
    fun enablejsapi(): Builder {
      addInt("enablejsapi", 0)
      return this
    }
