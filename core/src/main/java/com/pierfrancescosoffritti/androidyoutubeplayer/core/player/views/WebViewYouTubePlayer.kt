...
private class YouTubePlayerImpl(private val webView: WebView) : YouTubePlayer {
  ...
  override fun loadVideo(videoId: String, startSeconds: Float) = webView.invoke("loadVideo", videoId, startSeconds).also {  }
...
/*  override fun getPlayBackRate(): PlayerConstants.PlaybackRate {
    return webView.invoke("getPlaybackRate")
  }*/
